        ...
        <div>
          <div className="relative w-1vw h-1vh overflow-hidden">
            ...
            >
              ...
              <div className="absolute top-40 left-10 border-2 rounded-lg p-10 w-40 border-black text-black">
                <h1 className="text-2xl uppercase font-black">Choose a City</h1>
                <ReactRouterLink  className=" block w-20 hover:font-black hover:italic hover:w-1/2" to="/Rabat" component={Link}>  
